...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@300;400;500;600&family=Karla:wght@300;400;500;600;700&family=Noto+Sans+Thai:wght@300;400;500;600&family=Noto+Serif+Thai:wght@300;400;600&display=swap",
      },
    ],
  }),
    ...
    <QueryClientProvider client={queryClient}>
      ...
      <LanguageProvider>
        <div
          className={
            useLuxuryTheme
              ? "public-luxury-shell flex min-h-screen flex-col bg-transparent text-foreground"
              : "site-shell flex min-h-screen flex-col bg-transparent text-foreground"
          }
        >
          <SiteHeader />
